...
public class Pop3Gui extends JFrame {
    ...
    public Pop3Gui() {
        ...
        logArea.setBackground(new Color(20, 20, 40)); // Dark blue background
    ...
    private void startServer() {
        ...
        addLog("SYSTEM: POP3 Server initialization...");
    }
    ...
    private void stopServer() {
        if (server != null) {
            ...
            stopButton.setEnabled(false);
            addLog("SYSTEM: POP3 Server stopped by administrator.");
        }
    }
