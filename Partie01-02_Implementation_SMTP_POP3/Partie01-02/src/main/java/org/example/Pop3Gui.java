...
public class Pop3Gui extends JFrame {
    ...
    public Pop3Gui() {
        setTitle("POP3 Server Supervision");
        setSize(700, 500);
        ...
        JLabel title = UIUtils.createHeaderLabel("POP3 ENGINE");
    ...
    private void stopServer() {
        if (server != null) {
            ...
            stopButton.setEnabled(false);
            addLog("SYSTEM: POP3 Engine terminated by administrator.");
        }
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(Pop3Gui::new);
    }
}
